...
if {$k_fmax == -1} {
    ...
    post_message "k_fmax is $k_fmax"
    post_message "fmax1 is $fmax1"
    post_message "k_clk_name_full is $k_clk_name_full"
    post_message "fmax2 is $fmax2"
    post_message "k_clk2x_name_full is $k_clk2x_name_full"
}
