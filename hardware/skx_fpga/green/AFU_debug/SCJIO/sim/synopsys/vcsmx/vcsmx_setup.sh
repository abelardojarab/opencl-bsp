...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_soft_core_jtag_io_160/sim/altera_soft_core_jtag_io.v" -work altera_soft_core_jtag_io_160
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/SCJIO.v"                                                                                          
fi
