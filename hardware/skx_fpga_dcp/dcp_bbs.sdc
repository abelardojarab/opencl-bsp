...
## VERSION "Version 17.0.0 Internal Build 247 03/06/2017 SJ Pro Edition"

## DATE    "Tue Mar  7 21:05:39 2017"
...
create_clock -name {mem|ddr4a|ddr4a_ref_clock} -period 3.752 -waveform { 0.000 1.876 } [get_ports {DDR4_RefClk}]
...
create_generated_clock -name {mem|ddr4a|ddr4a_vco_clk} -source [get_ports {DDR4_RefClk}] -multiply_by 4 -master_clock {mem|ddr4a|ddr4a_ref_clock} [get_nets {mem|ddr4a|ddr4a|arch|arch_inst|pll_inst|phy_clk_phs[0]}] 
create_generated_clock -name {mem|ddr4a|ddr4a_vco_clk_1} -source [get_ports {DDR4_RefClk}] -multiply_by 4 -master_clock {mem|ddr4a|ddr4a_ref_clock} [get_nets {mem|ddr4a|ddr4a|arch|arch_inst|pll_inst|pll_inst~_Duplicate_1VCOPH0}] 
create_generated_clock -name {mem|ddr4a|ddr4a_vco_clk_2} -source [get_ports {DDR4_RefClk}] -multiply_by 4 -master_clock {mem|ddr4a|ddr4a_ref_clock} [get_nets {mem|ddr4a|ddr4a|arch|arch_inst|pll_inst|pll_inst~_DuplicateVCOPH0}] 
...
create_generated_clock -name {mem|ddr4b|ddr4b_vco_clk_0} -source [get_ports {DDR4_RefClk}] -multiply_by 4 -master_clock {mem|ddr4a|ddr4a_ref_clock} [get_nets {mem|ddr4b|ddr4b|arch|arch_inst|pll_inst|phy_clk_phs[0]}] 
create_generated_clock -name {mem|ddr4b|ddr4b_vco_clk_1} -source [get_ports {DDR4_RefClk}] -multiply_by 4 -master_clock {mem|ddr4a|ddr4a_ref_clock} [get_nets {mem|ddr4b|ddr4b|arch|arch_inst|pll_inst|pll_inst~_Duplicate_1VCOPH0}] 
create_generated_clock -name {mem|ddr4b|ddr4b_vco_clk_2} -source [get_ports {DDR4_RefClk}] -multiply_by 4 -master_clock {mem|ddr4a|ddr4a_ref_clock} [get_nets {mem|ddr4b|ddr4b|arch|arch_inst|pll_inst|pll_inst~_DuplicateVCOPH0}] 
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_core_cal_slave_clk}] -rise_to [get_clocks {mem|ddr4a|ddr4a_core_cal_slave_clk}]  0.050  -enable_same_physical_edge
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_core_cal_slave_clk}] -fall_to [get_clocks {mem|ddr4a|ddr4a_core_cal_slave_clk}]  0.050  -enable_same_physical_edge
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_core_cal_slave_clk}] -rise_to [get_clocks {mem|ddr4a|ddr4a_core_cal_slave_clk}]  0.050  -enable_same_physical_edge
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_core_cal_slave_clk}] -fall_to [get_clocks {mem|ddr4a|ddr4a_core_cal_slave_clk}]  0.050  -enable_same_physical_edge
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_core_usr_clk}] -rise_to [get_clocks {mem|ddr4a|ddr4a_core_usr_clk}]  0.030  -enable_same_physical_edge
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_core_usr_clk}] -fall_to [get_clocks {mem|ddr4a|ddr4a_core_usr_clk}]  0.030  -enable_same_physical_edge
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_core_usr_clk}] -rise_to [get_clocks {mem|ddr4a|ddr4a_core_usr_clk}]  0.030  -enable_same_physical_edge
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_core_usr_clk}] -fall_to [get_clocks {mem|ddr4a|ddr4a_core_usr_clk}]  0.030  -enable_same_physical_edge
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_10}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_10}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_10}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_10}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_9}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_9}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_9}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_9}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_8}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_8}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_8}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_8}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_7}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_7}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_7}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_7}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_6}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_6}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_6}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_6}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_5}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_5}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_5}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_5}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_4}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_4}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_4}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_4}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_3}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_3}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_3}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_3}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_2}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_2}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_2}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_2}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_1}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_1}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_1}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_1}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_0}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_0}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_0}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_wf_clk_0}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_2}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_2}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_2}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_2}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_1}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_1}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_1}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_1}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_0}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_0}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_0}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4b|ddr4b_vco_clk_0}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_10}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_10}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_10}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_10}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_9}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_9}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_9}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_9}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_8}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_8}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_8}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_8}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_7}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_7}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_7}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_7}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_6}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_6}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_6}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_6}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_5}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_5}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_5}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_5}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_4}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_4}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_4}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_4}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_3}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_3}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_3}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_3}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_2}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_2}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_2}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_2}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_1}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_1}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_1}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_1}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_0}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_0}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_0}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_wf_clk_0}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_vco_clk_2}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_vco_clk_2}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_vco_clk_2}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_vco_clk_2}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_ref_clock}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_ref_clock}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_ref_clock}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.030  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_ref_clock}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.030  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_vco_clk}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_vco_clk}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_vco_clk}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_vco_clk}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_vco_clk_1}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -rise_from [get_clocks {mem|ddr4a|ddr4a_vco_clk_1}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_vco_clk_1}] -rise_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
set_clock_uncertainty -fall_from [get_clocks {mem|ddr4a|ddr4a_vco_clk_1}] -fall_to [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.200  
...
set_clock_uncertainty -rise_from [get_clocks {altera_ts_clk}] -rise_to [get_clocks {SYS_RefClk}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {altera_ts_clk}] -fall_to [get_clocks {SYS_RefClk}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {altera_ts_clk}] -rise_to [get_clocks {SYS_RefClk}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {altera_ts_clk}] -fall_to [get_clocks {SYS_RefClk}]  0.020  
...
set_input_delay -add_delay  -clock [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.000 [get_ports {DDR4A
]
set_output_delay -add_delay  -clock [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.000 [get_ports {DDR4B_PAR}]
set_output_delay -add_delay  -clock [get_clocks {mem|ddr4a|ddr4a_ref_clock}]  0.000 [get_ports {DDR4B_RESET_L}]
...
set_clock_groups -asynchronous -group [get_clocks {*|qph_user_clk_fpll_u0|xcvr_fpll_a10_0|outclk0}] -group [get_clocks {*|qph_user_clk_fpll_u0|xcvr_fpll_a10_0|outclk1}] -group [get_clocks {SYS_RefClk}] -group [get_clocks {ETH_RefClk}] -group [get_clocks {altera_reserved_tck}] -group [get_clocks {mem|ddr4a|ddr4a_ref_clock}] -group [get_clocks {fpga_top|inst_fiu_top|inst_pcie0_ccib_top|pcie_hip0|pcie_a10_hip_0|wys~CORE_CLK_OUT}] -group [get_clocks {u0|dcp_iopll|dcp_iopll|clk2x}] -group [get_clocks {u0|dcp_iopll|dcp_iopll|clk1x}] -group [get_clocks {DDR4A_DQS_P[*]_IN DDR4B_DQS_P[*]_IN mem|ddr4a|ddr4a_core_usr_clk mem|ddr4a|ddr4a_phy_clk_* mem|ddr4b|ddr4b_phy_clk_*}] 
...
set_false_path -to [get_keepers {{DDR4A_A[0]} {DDR4A_A[1]} {DDR4A_A[2]} {DDR4A_A[3]} {DDR4A_A[4]} {DDR4A_A[5]} {DDR4A_A[6]} {DDR4A_A[7]} {DDR4A_A[8]} {DDR4A_A[9]} {DDR4A_A[10]} {DDR4A_A[11]} {DDR4A_A[12]} {DDR4A_A[13]} {DDR4A_A[14]} {DDR4A_A[15]} {DDR4A_A[16]} DDR4A_ACT_L {DDR4A_BA[0]} {DDR4A_BA[1]} {DDR4A_BG[0]} {DDR4A_BG[1]} DDR4A_CKE DDR4A_CS_L DDR4A_ODT DDR4A_PAR}]
...
set_false_path -to [get_keepers {{DDR4B_A[0]} {DDR4B_A[1]} {DDR4B_A[2]} {DDR4B_A[3]} {DDR4B_A[4]} {DDR4B_A[5]} {DDR4B_A[6]} {DDR4B_A[7]} {DDR4B_A[8]} {DDR4B_A[9]} {DDR4B_A[10]} {DDR4B_A[11]} {DDR4B_A[12]} {DDR4B_A[13]} {DDR4B_A[14]} {DDR4B_A[15]} {DDR4B_A[16]} DDR4B_ACT_L {DDR4B_BA[0]} {DDR4B_BA[1]} {DDR4B_BG[0]} {DDR4B_BG[1]} DDR4B_CKE DDR4B_CS_L DDR4B_ODT DDR4B_PAR}]
...
set_max_delay -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] 100.000
set_max_delay -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] 100.000
set_max_delay -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] 100.000
set_max_delay -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] 100.000
set_max_delay -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] 100.000
set_max_delay -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] 100.000
set_max_delay -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] 100.000
set_max_delay -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] 100.000
set_max_delay -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] 100.000
set_max_delay -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] 100.000
...
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
...
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie1_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie1_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie1_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie1_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
set_net_delay -max -value_multiplier 0.800 -get_value_from_clock_period dst_clock_period -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie1_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie1_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}]
...
set_max_skew -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] -get_skew_value_from_clock_period src_clock_period -skew_value_multiplier 0.800 
set_max_skew -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_CfgTx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -get_skew_value_from_clock_period src_clock_period -skew_value_multiplier 0.800 
set_max_skew -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] -get_skew_value_from_clock_period src_clock_period -skew_value_multiplier 0.800 
set_max_skew -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Tx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -get_skew_value_from_clock_period src_clock_period -skew_value_multiplier 0.800 
set_max_skew -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] -get_skew_value_from_clock_period src_clock_period -skew_value_multiplier 0.800 
set_max_skew -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C1Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -get_skew_value_from_clock_period src_clock_period -skew_value_multiplier 0.800 
set_max_skew -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] -get_skew_value_from_clock_period src_clock_period -skew_value_multiplier 0.800 
set_max_skew -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Tx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -get_skew_value_from_clock_period src_clock_period -skew_value_multiplier 0.800 
set_max_skew -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|*rdptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|ws_dgrp|dffpipe*|dffe*}] -get_skew_value_from_clock_period src_clock_period -skew_value_multiplier 0.800 
set_max_skew -from [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|delayed_wrptr_g*}] -to [get_keepers {fpga_top|inst_fiu_top|inst_ccip_fabric_top|inst_pcie0_cdc|inst_async_C0Rx_fifo|fifo_0|dcfifo_component|auto_generated|rs_dgwp|dffpipe*|dffe*}] -get_skew_value_from_clock_period src_clock_period -skew_value_multiplier 0.800 
