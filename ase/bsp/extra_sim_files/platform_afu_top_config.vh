...
//
// Platform: s10_pac_dc_hssi
// AFU top-level interface: ccip_std_afu_avalon_mm
//

`ifndef __PLATFORM_AFU_TOP_CONFIG_VH__
`define __PLATFORM_AFU_TOP_CONFIG_VH__

`define PLATFORM_CLASS_NAME "S10_PAC_DC_HSSI"
`define PLATFORM_CLASS_NAME_IS_S10_PAC_DC_HSSI 1

// This may be passed as the "intended_device_family"
// parameter to simulated megafunctions.
`define PLATFORM_INTENDED_DEVICE_FAMILY "Stratix10"
...
`define PLATFORM_FPGA_FAMILY_S10 1
`define PLATFORM_FPGA_PAC 1
`define PLATFORM_FPGA_PAC_DC 1
...
// local-memory
`define AFU_TOP_REQUIRES_LOCAL_MEMORY_AVALON_MM 4
...
`define PLATFORM_PARAM_LOCAL_MEMORY_DATA_WIDTH 576
`define PLATFORM_PARAM_LOCAL_MEMORY_SUGGESTED_TIMING_REG_STAGES 2

// clocks
`define AFU_TOP_REQUIRES_CLOCKS_PCLK3_USR2 1
`define PLATFORM_PARAM_CLOCKS_PCLK_FREQ 250
