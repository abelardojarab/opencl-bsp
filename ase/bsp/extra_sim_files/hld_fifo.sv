...
//  There is little to be gained beyond the maximum earliness supported by the underlying fifo.                                                                                     //
//                                                                                                                                                                                  //
//  Underlying fifo   | Maximum useful STALL_IN_EARLINESS | Maximum useful VALID_IN_EARLINESS                                                                                       //
//  ------------------+-----------------------------------+----------------------------------                                                                                       //
//  High speed fifo   | 3                                 | 0                                                                                                                       //
//  Low latency fifo  | 1                                 | 1                                                                                                                       //
//  Zero latency fifo | 1                                 | 1                                                                                                                       //
//                                                                                                                                                                                  //
//  RESET CONFIGURATION                                                                                                                                                             //
//  ===================                                                                                                                                                             //
...
module hld_fifo #(
    ...
    parameter int WIDTH = 0,                        // width of data path, at least 0
    parameter int DEPTH = 1,                        // capacity of the fifo, at least 1
...
(
    ...
    `endif
    generate
    if ((STYLE != "hs") && (STYLE != "ll") && (STYLE != "zl")) begin
        $fatal(1, "hld_fifo: illegal value of STYLE = %s, legal values are \"hs\", \"ll\", or \"zl\"\n", STYLE);
    end
    endgenerate
    `ifdef ALTERA_RESERVED_QHD
    `else
